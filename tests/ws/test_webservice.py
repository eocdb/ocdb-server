...
class UrlPatternTest(unittest.TestCase):
    ...
    def test_url_pattern_works(self):
        ...
        re_pattern = webservice.url_pattern('/open/ws{id1}/wf{id2}')
        ...
        re_pattern = webservice.url_pattern('/ws/{base_dir}/res/{res_name}/add')
