...
class DbSubmissionTest(TestCase):
    ...
    def test_to_dict(self):
        ...
        subm = DbSubmission(status="Hellyeah", user_id='Tom', submission_id="submitme", path="/the/archive/root/",
                            ...
                            allow_publication=True, updated_date=datetime(2002, 2, 3, 4, 5, 6),
                            store_user_path='Tom_Helge', )

        self.assertEqual({'date': '2001-02-03 04:05:06',
                          'file_refs': [],
                          'files': [{'filename': 'Hans',
                          ...
                          'publication_date': '2002-02-03 04:05:06',
                          'updated_date': '2002-02-03 04:05:06',
    ...
    def test_from_dict(self):
        subm_dict = {'date': datetime(2002, 3, 4, 5, 6, 7),
                     ...
                     'publication_date': datetime(2002, 2, 3, 4, 5, 6),
                     'updated_date': datetime(2002, 2, 3, 4, 5, 6),
                     'allow_publication': True,
                     'store_sub_path': 'Tom_Helge',
                     'user_id': 'Tom'}
